...
for lang in config["langs"]:
    try:
        file_langjs = open(Path2emptypo + lang + '/LC_MESSAGES/objektart.po','w')
    except:
        print "is the path to the directory i18n correct?"
        sys.exit()
    ...
    # written
    print 'Translation in ' + myLangDict[lang] + ' accomplished. Verify ' + Path2emptypo + lang + '/LC_MESSAGES/objektart.po'
