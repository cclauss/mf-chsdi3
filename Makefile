...
help:
	...
	@echo "- dev                Build the dev version of the app"
	@echo "- int                Build the int version of the app"
	@echo "- prod               Build the productive version if the app"
...
.PHONY: test
test:
	PYTHONPATH=${PYTHONPATH} ${NOSE_CMD} chsdi/tests/
