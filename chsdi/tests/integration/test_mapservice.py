...
class TestMapServiceView(TestsBase):
    ...
    def test_identify_not_valid_geom_type_on_grid(self):
        params = {'geometry': '555000,171125,556000,172125', 'geometryFormat': 'geojson', 'geometryType': 'esriGeometryEnvelope', 'imageDisplay': '1920,793,96', 'layers': 'all:ch.bfe.windenergie-geschwindigkeit_h50',
                  'mapExtent': '346831.18224960007,86207.5717544,826831.1822496001,284457.57175440004', 'returnGeometry': 'true', 'tolerance': '10'}
